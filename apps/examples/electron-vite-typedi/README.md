...
Electron + Vite + React + TypeScript example using **TypeDI** for dependency injection with [electron-ipc-controller](https://github.com/electron-ipc-controller/electron-ipc-controller).
