...
const GITHUB_REPO = "https://github.com/metacurb/electron-ipc-controller";
...
const config: Config = {
  baseUrl: "/electron-ipc-controller/",
  ...
  presets: [
    [
      "classic",
      {
        blog: false,
        docs: {
          editUrl: "https://github.com/metacurb/electron-ipc-controller/tree/main/apps/docs/",
  ...
  projectName: "electron-ipc-controller",
  ...
  themeConfig: {
      ...
      links: [
        {
          items: [
            {
              href: "https://github.com/metacurb/electron-ipc-controller",
              label: "Repository",
            },
            {
              href: "https://github.com/metacurb/electron-ipc-controller/issues",
              label: "Issues",
            },
          ],
          title: "GitHub",
        ...
        {
          items: [
            { href: "https://www.npmjs.com/", label: "@electron-ipc-controller/core" },
            { href: "https://www.npmjs.com/", label: "@electron-ipc-controller/vite-plugin" },
          ],
          title: "Packages",
        },
      ],
    ...
    navbar: {
      ...
      logo: {
        alt: "Electron IPC Controller",
        src: "img/logo.png",
      },
      title: "Electron IPC Controller",
    },
    prism: {
