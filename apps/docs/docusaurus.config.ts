...
const SITE_URL = "https://metacurb.github.io";
const BASE_URL = "/electron-ipc-bridge/";
const canonicalUrl = `${SITE_URL}${BASE_URL}`;
...
const config: Config = {
  ...
  headTags: [
    {
      ...
      innerHTML: JSON.stringify({
        ...
        description:
          "Type-safe, class-based IPC for Electron. Controllers, decorators, and auto-generated renderer types.",
  ...
  themeConfig: {
    ...
    metadata: [
      {
        content:
          "Type-safe, class-based IPC for Electron. Controllers, decorators, and auto-generated renderer types. No manual ipcMain.handle or preload wire-up.",
        name: "description",
      },
      {
        content: "electron, ipc, typescript, type-safe, decorators, ipc-main, preload, vite, electron-ipc-bridge",
        name: "keywords",
      },
      { content: "website", property: "og:type" },
      {
        content: `${canonicalUrl}img/logo.png`,
        property: "og:image",
      },
